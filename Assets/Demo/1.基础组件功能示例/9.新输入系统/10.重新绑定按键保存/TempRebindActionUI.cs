...
namespace Demo.Basic.InputDemo._10
{
    ...
    /// 临时UI界面
    /// </summary>
    public class TempRebindActionUI : MonoBehaviour
    {
        /// <summary>
        ...
        protected void OnEnable()
        {
            if (s_RebindActionUIs == null)
                s_RebindActionUIs = new List<TempRebindActionUI>();
        ...
        private static List<TempRebindActionUI> s_RebindActionUIs;
        ...
        [Serializable]
        public class UpdateBindingUIEvent : UnityEvent<TempRebindActionUI, string, string, string>
        {
        }

        [Serializable]
        public class InteractiveRebindEvent : UnityEvent<TempRebindActionUI, InputActionRebindingExtensions.RebindingOperation>
        {
        }
    }
}
